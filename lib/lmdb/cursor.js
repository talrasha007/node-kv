...
Cursor.prototype.lowerBound = function (key, val) {
    return arguments.length === 1 ?
        this._cursor.lowerBound(this._keySanitize(key)) :
        this._cursor.lowerBound(this._keySanitize(key), this._valSanitize(val));
};
