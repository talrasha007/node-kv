...
Db.prototype.cursor = function (txn) {
    return new Cursor(this, txn);
};
...
Db.prototype.exists = function (key, val, txn) {
    return this._db.exists(this._keySanitize(key), this._valSanitize(val), txn && txn._txn);
};
